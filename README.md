...
**OpenSCIRanking** 是一个面向开源使用的期刊排序项目模板，目标是用数据驱动的方法（目前 v2 版本采用改进的 PageRank）替代传统“自上而下拍脑袋”的期刊分区逻辑。我们坚信“代码即法则”，致力于提供一个完全开源、数据透明、且基于底层论文引用网络自然生长的自下而上评价框架。在这个框架内，没有任何黑箱操作，接受学术共同体的检验。
